...
def read(name):
    p = ROOT / name
    if not p.exists():
        raise SystemExit(f"ERROR: required Beta 3.1 file is missing: {name}")
...
sources = {
    ...
    "RELEASE_NOTES_v0.5.0-2k25-beta3.1.md": read("RELEASE_NOTES_v0.5.0-2k25-beta3.1.md"),
    "usgs_lidar_parser.py": read("usgs_lidar_parser.py"),
}

checks = [
    ("GUI version", "tgc_gui.py", 'TGC_GUI_VERSION = "v0.5.0-2k25-beta3.1"'),
    ("Visible app title", "tgc_gui.py", 'TGC_APP_TITLE = "TGC Designer Tools 2K25 - Beta 3.1 Hotfix"'),
    ...
    ("Auto CRS canonical EPSG marker", "usgs_lidar_parser.py", "TGC_AUTO_LIDAR_CRS_CANONICAL_EPSG_V2"),
    ("Auto CRS canonical EPSG rebuild", "usgs_lidar_parser.py", '"epsg:" + str(horizontal_epsg)'),
    ("README hotfix version", "README.md", "**v0.5.0-2k25-beta3.1**"),
]
...
failed = []
print("TGC Designer Tools 2K25 Beta 3.1 HOTFIX source verification")
print("Folder:", ROOT)
print()
...
required_files = [
    ...
    "RELEASE_NOTES_v0.5.0-2k25-beta3.1.md",
    "auto_red_mask.py",
    "cfs_georef.py",
    "lidar_fast_native.c",
    "lidar_fast_native.py",
...
print()
print("Required Beta 3.1 hotfix release files:")
...
print("Visible application title: TGC Designer Tools 2K25 - Beta 3.1 Hotfix")
print(r"Expected executable: C:\TGC-Designer-Tools\dist\tgc_gui_2k25_beta3_1.exe")
